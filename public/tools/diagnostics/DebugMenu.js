...
export class DebugMenu {
  ...
  _createUI() {
    ...
    console.log("[DEBUG] Debug UI created with maximize functionality and control panels");
  }
  ...
  _createMaterialControls() {
    ...
    resetButton.addEventListener('click', () => {
      ...
      // Reset UI controls
      document.getElementById('material-shininess').value = this.materialDefaults.shininess;
      document.getElementById('material-emissive').value = this.materialDefaults.emissiveIntensity;
    });
  ...
  _createLightingControls() {
    ...
    container.appendChild(
      this._createSliderControl(
        ...
        0.05,
        (value) => {
          console.log(`[DEBUG] Setting directional light intensity to ${value}`);
    ...
    resetButton.addEventListener('click', () => {
      ...
      // Reset UI controls
      document.getElementById('ambient-intensity').value = this.lightingDefaults.ambientIntensity;
      document.getElementById('ambient-color').value = this.lightingDefaults.ambientColor;
      document.getElementById('directional-intensity').value = this.lightingDefaults.directionalIntensity;
    });
    container.appendChild(resetButton);
  }
  ...
  _createGridControls() {
    ...
    regenerateButton.addEventListener('click', () => {
      if (this.gridGeneratorFn) {
        console.log("[DEBUG] Regenerating grid with new settings", this.changes.grid);
    ...
    resetButton.addEventListener('click', () => {
      ...
      // Reset UI controls
      document.getElementById('grid-horizontal').value = this.gridDefaults.horizontalSpacing;
      document.getElementById('grid-vertical').value = this.gridDefaults.verticalFactor;
    });
    container.appendChild(resetButton);
  }
      ...
      [1, 2].forEach(index => {
        if (hex.material && hex.material[index]) {
          ...
          if (this.changes.material.emissiveIntensity !== undefined) {
            hex.material[index].emissiveIntensity = this.changes.material.emissiveIntensity;
          }
        }
      });
    });
